...
directory_path = '/home/w78998ss/Visualization_Data/ArrowsPlot/Ref_Syn9R'

# Define the reference genome path for Syn9R
new_reference_genome_path = os.path.join(directory_path, 'BY4741_synIXR.fa')

# Define the paths for scaffolded assemblies for Syn9R
new_scaffolded_assembly_paths = [
    os.path.join(directory_path, 'ragtag.scaffold_004.fasta'),
    os.path.join(directory_path, 'ragtag.scaffold_005.fasta'),
    os.path.join(directory_path, 'ragtag.scaffold_006.fasta'),
    os.path.join(directory_path, 'ragtag.scaffold_007.fasta')
]

# Define the paths for rearrangement data CSV files for Syn9R
new_rearrangement_data_paths = [
    os.path.join(directory_path, 'rear_filtered_LUs9R_x_refdb004_df.txt_data.csv'),
    os.path.join(directory_path, 'rear_filtered_LUs9R_x_refdb005_df.txt_data.csv'),
    os.path.join(directory_path, 'rear_filtered_LUs9R_x_refdb006_df.txt_data.csv'),
    os.path.join(directory_path, 'rear_filtered_LUs9R_x_refdb007_df.txt_data.csv')
]
...
reference_line, = ax.plot([0, reference_len], [0] * 2, color='yellow', linewidth=5, label='Reference Genome (BY4741_synIXR)')
...
for idx, (scaffolded_assembly, label, rearrangement_data_path) in enumerate(
    ...
    scaffolded_label = f'Scaff_{idx+4:03d}'  # Label format: Scaff_004, Scaff_005, Scaff_006, Scaff_007
...
ax.set_yticklabels(['Reference Genome (BY4741_synIXR)', 'Scaff_004', 'Scaff_005', 'Scaff_006', 'Scaff_007'])
...
output_plot_path = os.path.join(directory_path, 'Arr_Syn9R.png')
