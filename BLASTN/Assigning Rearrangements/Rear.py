...
file_names = [
    "LUs2,3_x_refdb008_df.txt",
    "LUs2,3_x_refdb009_df.txt",
    "LUs2,3_x_refdb010_df.txt",
    "LUs3,6,9R_x_refdb012_df.txt",
    "LUs3,6,9R_x_refdb013_df.txt",
    "LUs3,6,9R_x_refdb014_df.txt",
    "LUs3,6,9R_x_refdb015_df.txt",
    "LUs5_x_refdbR6_df.txt",
    "LUs9R_x_refdb004_df.txt",
    "LUs9R_x_refdb005_df.txt",
    "LUs9R_x_refdb006_df.txt",
    "LUs9R_x_refdb007_df.txt"
]

# Specify the directory path where the input files are located
input_directory = "/home/w78998ss/Blast_Data/Rearrangements"

# Specify the output folder path within the input directory
output_folder = os.path.join(input_directory, "Rearg")
...
for file_name in file_names:
    ...
    # Define the output file path within the "Rearg" folder
